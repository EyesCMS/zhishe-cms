...
public class CmsActivityController {
    ...
    public ResponseEntity<Object> activityApply(@Validated CmsClubActivityParam param,
            @RequestParam("imgUrl") MultipartFile imgUrl) {
        clubService.activityApply(param, imgUrl);
    ...
    public ResponseEntity<Object> listActivitiesApply(CmsActivityQuery param,
        ...
        return ResponseEntity.ok().body(CommonPage.restPage(clubService.listActivitiesApply(param,
            paginationParam, orderByParam)));
    }
    ...
    public ResponseEntity<Object> getApply(@PathVariable(value = "clubId") Integer clubId,
            CmsActivityQuery param, @Validated PaginationParam paginationParam,
            OrderByParam orderByParam) {
        return ResponseEntity.ok().body(CommonPage.restPage(clubService.listActivitiesApply(clubId,
            param, paginationParam, orderByParam)));
    }
