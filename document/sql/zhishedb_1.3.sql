...
) ENGINE = InnoDB AUTO_INCREMENT = 30 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '公告' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cms_bulletin
-- ----------------------------
INSERT INTO `cms_bulletin` VALUES (1, 5000, 'string', 'aaassss', '2020-04-29 14:06:59', '2020-04-29 14:07:08');
...
INSERT INTO `cms_bulletin` VALUES (24, 5000, '123', 'bbbbb11b', '2020-04-30 13:43:33', '2020-04-30 13:43:33');
INSERT INTO `cms_bulletin` VALUES (25, 5000, '1234', 'bbbbb11b', '2020-04-30 13:43:51', '2020-04-30 13:43:51');
INSERT INTO `cms_bulletin` VALUES (28, 10000, 'test2', '112233', '2020-05-01 13:50:31', '2020-05-01 13:50:31');
INSERT INTO `cms_bulletin` VALUES (29, 10000, 'test3', '11229933', '2020-05-01 13:50:49', '2020-05-01 13:50:49');
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社长换届申请' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 10015 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社团' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cms_club
-- ----------------------------
INSERT INTO `cms_club` VALUES (5000, '足球社', 10090, 1, NULL, NULL, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', NULL, NULL, NULL, NULL, 0);
INSERT INTO `cms_club` VALUES (10000, '软件学社', 10089, 2, '10000', NULL, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', NULL, NULL, 2017, NULL, 0);
INSERT INTO `cms_club` VALUES (10001, 'xx社', 10088, 1, NULL, NULL, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', 1, NULL, NULL, '2020-04-23 21:27:56', 0);
INSERT INTO `cms_club` VALUES (10003, 'xxyyzz社', 10088, 2, NULL, NULL, 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', 1, NULL, NULL, '2020-04-24 20:20:23', 0);
INSERT INTO `cms_club` VALUES (10011, '5社', 10094, 1, NULL, NULL, NULL, 1, NULL, NULL, '2020-04-26 23:09:44', 1);
INSERT INTO `cms_club` VALUES (10012, '6社', 10094, 1, NULL, NULL, NULL, 1, NULL, NULL, '2020-04-28 12:02:17', 0);
INSERT INTO `cms_club` VALUES (10013, '7社', 10094, 1, NULL, NULL, NULL, 0, NULL, NULL, '2020-04-28 19:53:37', 0);
INSERT INTO `cms_club` VALUES (10014, '8社', 10094, 1, NULL, NULL, NULL, 0, '没什么XX类', NULL, '2020-05-01 15:00:13', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社团创建申请' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `cms_club_create_apply` VALUES (16, 10094, 'test6', '8社', 0, '没什么XX类', 'make friends', '2020-04-30 18:16:24', '2020-05-01 15:00:13', 1);
INSERT INTO `cms_club_create_apply` VALUES (17, 10088, 'test', '1', 0, 'art', '1', '2020-05-01 14:32:03', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '解散社团申请' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `cms_club_disband_apply` VALUES (19, 10012, '也没为什么', '2020-04-30 18:25:38', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '加入社团申请' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社团认证申请' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cms_official_change_apply
-- ----------------------------
INSERT INTO `cms_official_change_apply` VALUES (1, 10012, '没为什么就是认证一下牛逼一点', '2020-04-28 12:03:13', '2020-04-29 16:21:46', 1);
INSERT INTO `cms_official_change_apply` VALUES (2, 10013, '也没为什么就是认证一下牛逼一点', '2020-04-30 18:43:56', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社员退出通知' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `cms_quit_notice` VALUES (3, 10088, 10013, '2020-05-01', '测试用');
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户社团关系' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cms_user_club_rel
-- ----------------------------
INSERT INTO `cms_user_club_rel` VALUES (1, 10088, 10000, NULL, NULL, '2020-04-28 14:56:26');
...
INSERT INTO `cms_user_club_rel` VALUES (21, 10089, 10012, NULL, NULL, '2020-05-01 14:52:48');
INSERT INTO `cms_user_club_rel` VALUES (22, 10094, 10014, NULL, NULL, '2020-05-01 15:00:13');
...
-- Records of fms_post
-- ----------------------------
INSERT INTO `fms_post` VALUES (1, 10088, '个人帖1', 'good or bad', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:05:15', 0, 0);
INSERT INTO `fms_post` VALUES (2, 5000, '活动1', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:06:47', 1, 0);
INSERT INTO `fms_post` VALUES (3, 5000, '活动1', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:06:47', 1, 1);
INSERT INTO `fms_post` VALUES (4, 5000, '活动2', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:16:47', 1, 0);
INSERT INTO `fms_post` VALUES (5, 5000, '活动3', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 13:06:47', 1, 0);
INSERT INTO `fms_post` VALUES (6, 10000, '活动4', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 15:06:47', 1, 0);
INSERT INTO `fms_post` VALUES (7, 10000, '活动xx', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:33:47', 1, 1);
INSERT INTO `fms_post` VALUES (8, 5000, '活动1xx', '这是一个社团的活动', 'https://unsplash.com/photos/mG28olYFgHI', '2020-04-29 14:56:47', 1, 1);
INSERT INTO `fms_post` VALUES (9, 10089, '个人帖2', '哈哈哈，真好玩', 'https://unsplash.com/photos/mG28olYFgHI', '2020-05-01 00:40:37', 0, 0);
INSERT INTO `fms_post` VALUES (10, 10088, '个人帖3', 'what a pity', 'https://unsplash.com/photos/mG28olYFgHI', '2020-05-01 00:41:11', 0, 0);
INSERT INTO `fms_post` VALUES (12, 10088, '这是一个帖子', '我又发帖了', NULL, '2020-05-01 13:00:00', 0, 0);
INSERT INTO `fms_post` VALUES (13, 10088, '这是一个帖子', '我又发帖了', NULL, '2020-05-01 13:02:27', 0, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '活动评论关系' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (10088, 'test', '$2a$10$VXZ9nkZF4R0jABsT1kxXvekwqtV4XSGaOFobOZePhANeZOcdgMo12', 'Bob', 'https://wpimg.wallstcn.com/f778738c-e4f8-4870-b634-56703b4acafe.gif', 'SE', 'bob@gmail.com', '12345678901', NULL, 'good good study, day day up', NULL, NULL, 0, 1);
